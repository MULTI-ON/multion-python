...
from ..types.session_step_stream import SessionStepStream
...
class SessionsClient:
    ...
    def step_stream(
        ...
        *,
        ...
        include_screenshot: typing.Optional[bool] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> typing.Iterator[SessionStepStream]:
        """
        ...
        with self._client_wrapper.httpx_client.stream(
            ...
            if 200 <= _response.status_code < 300:
                ...
                for _sse in _event_source.iter_sse():
                    yield typing.cast(SessionStepStream, construct_type(type_=SessionStepStream, object_=json.loads(_sse.data)))  # type: ignore
                return
            _response.read()
            if _response.status_code == 422:
                raise UnprocessableEntityError(
...
class AsyncSessionsClient:
    ...
    async def step_stream(
        ...
        *,
        ...
        include_screenshot: typing.Optional[bool] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> typing.AsyncIterator[SessionStepStream]:
        """
        Allows for browsing the web using detailed natural language instructions in a step mode for a session with a given session ID
